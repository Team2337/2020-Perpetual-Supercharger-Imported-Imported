...
public final class Constants {
    ...
    public static final double MODULE0_ANGLE_OFFSET = Math.toRadians(-50.7019); //0; //TODO: Add this value
    ...
    public static final double MODULE1_ANGLE_OFFSET = 3.0854; //2.3; //TODO: Add this value
    // NOTE FOR FUTURE STUFF: 45 degrees is approximately 0.7854
    ...
    public static final double MODULE3_ANGLE_OFFSET = Math.toRadians(-286.4273);//1.482; //1.482
  
    // public static final double MODULE0_ANGLE_OFFSET = Math.toRadians(-50.7019);
    // public static final double MODULE1_ANGLE_OFFSET = Math.toRadians(-128.5812);
    // public static final double MODULE2_ANGLE_OFFSET = Math.toRadians(-346.6324);
    // public static final double MODULE3_ANGLE_OFFSET = Math.toRadians(-286.4273);
